...
export function getHateoas(directionId) {
    return request({
        url: API_BASE_URL + "/directions/" + 1 + "/waypoints",
        method: 'GET'
    });
}
export function getWaypointsByDirectionId(directionId) {
    console.log('been here')
    return request({
        url: API_BASE_URL + "/directions/" + directionId + "/waypoints",
        method: 'GET'
    });
}