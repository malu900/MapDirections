...
import com.location.maps.service.UserService;
...
public class UserControllerImpl implements UserController {
    ...
    @Autowired
    public UserControllerImpl(UserRepository userRepository, DirectionService directionService, DirectionRepository directionRepository, UserService userService) {
...
//        userRepository.save(usermodel);
        userService.createFavoriteDirections(userPrincipal, username, id);
